 ...
 * class construction.
 */
public class StateHold extends JLabel implements FocusListener, DocumentListener {
	/**
	 * 
	 */
	...
	public StateHold(String text, JTextComponent component) {
		this(text, component, Show.ALWAYS);
	}

	public StateHold(String text, JTextComponent component, Show show) {
